...
from core.cli.commands.arxiv import get_sync_status, sync_abstracts
from core.cli.commands.arxiv.sync import (
...
class TestSyncStatus:
    ...
    @patch("core.cli.commands.arxiv.sync._get_sync_metadata")
    @patch("core.cli.commands.arxiv.sync.get_config")
...
class TestIncrementalSync:
    ...
    @patch("core.cli.commands.arxiv.sync._embed_and_store_abstracts")
    @patch("core.cli.commands.arxiv.sync._filter_existing")
    @patch("core.cli.commands.arxiv.sync._fetch_recent_papers")
    @patch("core.cli.commands.arxiv.sync._update_sync_metadata")
    @patch("core.cli.commands.arxiv.sync._get_last_sync_date")
    @patch("core.cli.commands.arxiv.sync.get_config")
...
class TestSyncMetadataHelpers:
    ...
    @patch("core.cli.commands.arxiv.sync.get_arango_config")
