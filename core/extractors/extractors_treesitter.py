...
class TreeSitterExtractor:
    ...
    def extract_symbols(self, file_path: str | Path, content: str | None = None) -> dict[str, Any]:
        """
    ...
    def _get_extends(self, node, content: str) -> str | None:
    ...
    def _extract_receiver(self, node, content: str) -> str | None:
    ...
    def _extract_function_name(self, declarator, content: str) -> str | None:
