...
class LaTeXExtractor(ExtractorBase):
    ...
    def __init__(self, config: ExtractorConfig | None = None, use_pandoc: bool = False, **kwargs):
        """
    ...
    def _extract_from_tar_gz(self, latex_path: Path, start_time: datetime) -> dict[str, Any]:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Read LaTeX content
            try:
                with open(main_tex, encoding='utf-8', errors='ignore') as f:
            ...
            if bbl_files:
                try:
                    with open(bbl_files[0], encoding='utf-8', errors='ignore') as f:
    ...
    def _convert_to_markdown(self, tex_path: Path) -> tuple[str | None, str | None]:
        """
    ...
    def extract_batch(self, latex_paths: list[str | Path], **kwargs) -> list[ExtractionResult]:  # type: ignore[override]
        """
