"""Sync commands for HADES CLI.

Provides abstract synchronization from ArXiv API to the local database.
Syncs metadata and abstracts, generates embeddings, and stores them for
semantic search - without downloading full PDFs.
"""
